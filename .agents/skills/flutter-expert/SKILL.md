---
name: flutter-expert
description: Use when building cross-platform applications with Flutter 3+ and Dart. Invoke for widget development, Bloc state management, GoRouter navigation, platform-specific implementations, performance optimization.
license: MIT
metadata:
  author: https://github.com/Jeffallan
  version: "1.0.0"
  domain: frontend
  triggers: Flutter, Dart, widget, Bloc, GoRouter, cross-platform
  role: specialist
...
| Structure | `references/project-structure.md` | Setting up project, feature-based structure |
| Performance | `references/performance.md` | Optimization, profiling, jank fixes |
| DI | `references/dependency-injection.md` | GetIt, service locator, dependency injection |
| Architecture | `references/clean-architecture.md` | Clean Architecture, layers, repositories, models, error handling |
...
Flutter 3.+, Dart 3.+, Bloc 8.x, GoRouter, GetIt, freezed, json_serializable, Dio, flutter_hooks
