...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Mapping HTML visual colors to Flutter
    // Primary #ff6a00 -> AppColors.secondary (based on previous edits where orange was secondary) 
    // Wait, let's verify theme. In ThemeConfig, AppColors.secondary is Orange.
    final primaryColor = AppColors.secondary;
    final secondaryColor = isDark ? Colors.white : AppColors.textMainLight; // "Navy" in design, but basically main text color
